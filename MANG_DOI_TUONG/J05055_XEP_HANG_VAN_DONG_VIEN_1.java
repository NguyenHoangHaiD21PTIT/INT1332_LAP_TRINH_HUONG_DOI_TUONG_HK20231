...
class VDV{
    ...
    public VDV(int x, String name, String ns, String bd, String kt){
        ...
        if(tmp < 18)this.uutien = 0;
        else if (tmp >=18 && tmp <= 24) this.uutien = 1;  
        else if (tmp >= 25 && tmp <= 32) this.uutien = 2;
        else this.uutien = 3;
        //Tạo xâu thời gian ưu tiên
        this.prio = "00:00:0" + this.uutien + "";
        ...
        //Tổng số giây trừ số giây ưu tiên để ra thành tích ưu tiên
        this.tongthuc = p - this.uutien; 
...
public class J05055_XEP_HANG_VAN_DONG_VIEN_1 {
    public static void main(String[] args){
        ...
        sc.nextLine();
        VDV []a = new VDV[n];
        for(int i = 0;i<n;i++) a[i] = new VDV(i + 1, sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine());
        ...
        //Sắp xếp mảng các tổng tg khác nhau giảm dần
